        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          <div class="navbar-header">
            <!-- Navbar Header--><a href="index.html" class="navbar-brand">
              ...
              <div class="brand-text brand-sm"><strong class="text-primary">Kim</strong><strong>Thoy</strong></div></a>
            <!-- Sidebar Toggle Btn-->
    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="{{route('admin.order')}}"> Orders </a>
              
              <li><a href="{{route('admin_comment')}}">Email </a></li>
              <li><a href="{{route('admin_comment')}}"> User </a></li>
